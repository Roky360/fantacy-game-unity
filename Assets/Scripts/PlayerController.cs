...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        _rb.velocity = new Vector3(
            horizontalInput * movementSpeed, _rb.velocity.y, verticalInput * movementSpeed);
        ...
        if (direction.magnitude > 0.01f)
        {
            ...
            transform.rotation =
                Quaternion.Slerp(transform.rotation, targetRotation,
                    Time.fixedDeltaTime * rotationSpeed); // Rotate the character towards the direction it's moving
